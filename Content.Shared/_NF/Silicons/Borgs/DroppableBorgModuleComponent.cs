...
public sealed partial class DroppableBorgModuleComponent : Component
{
    ...
    /// <summary>
    /// The placeholder entities spawned for this module.
    /// Spawned once at module creation, only deleted when the module is deleted.
    /// </summary>
    [DataField, AutoNetworkedField]
    public List<EntityUid> Placeholders = new();
